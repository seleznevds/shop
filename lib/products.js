...
export const productsApi = {
    getList: ({offset = 0, limit = 10,  headers = {}, page} = {}) => {
    ...
    getPresignedPostData: ({name, type}) => {
        return httpTransport({
            method: "get",
            url: "/api/products/sign-s3-post",
            data: {
                name,
                type
            }
    ...
    uploadFileWithPrepost: ({formData, url}) => {
        return httpTransport({
            method: "post",
            url,
            data: formData
